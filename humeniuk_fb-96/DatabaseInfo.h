...
struct Knot
{
    ...
    string  DatabaseColumn;     // Имя стобца
    string  ColumnTypeOfData;   // Тип данных
};
class DatabaseInfo
{
...
public:// Спецификатор доступа public
    ...
    Knot* Insert(Knot* pos, string pDatabaseName, string pDatabaseColumn, string pColumnTypeOfData);//вставка перед pos
    ...
    void CenterString(string& pDatabaseName, string& pDatabaseColumns, const size_t& width, string* pLastLine);        //Функция размещения таблицы по центру конольного приложения
